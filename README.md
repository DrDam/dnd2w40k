...
Ce projet est **open source** : son contenu est librement consultable, modifiable et redistribuable conformément à sa licence. Toutes les contributions sont les bienvenues afin d'enrichir et de pérenniser le projet.
...
This project is **open source**. Its content is freely available under the project's license, and contributions from the community are highly encouraged to help the project grow and evolve.
