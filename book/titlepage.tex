...
{\Large\bfseries\color{white} Warhammer 40 000 x Donjon \& Dragon 5e.\par}

\vspace{4cm}

{\Huge\bfseries\color{white} \BookSubtitle\par}

\vfill

{\large\color{white} Originellement crée par Klefgun (2020), traduit en Français et adapté par DrDam (2026)\par}
