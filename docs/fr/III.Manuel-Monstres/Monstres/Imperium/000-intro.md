...
Au sein des innombrables mondes de l'Imperium qui s'étend à travers la galaxie, les nombreuses factions de l'Imperium sont en perpétuel mouvement, faisant sans cesse avancer le plan de l'Empereur-Dieu visant à conquérir à terme l'ensemble de la galaxie.

*Liste des fiches* {.table-title .wide}

| Facteur de puissance | Groupe | Nom | Description |
|:-:|---| -----|------------|
...
| 1 (200 XP) | Adeptus Mechanicus | [Ingénieur](Ingenieur.md#ingenieur) | Humanoïde (Techno-fusionné) de taille moyenne, loyal neutre |
...
| 22 (15 100 XP) | Adeptus Mechanicus | [Chevalier Impérial](Chevalier.md#Chevalier) | Construct Gigantesque, tout alignement loyal |
