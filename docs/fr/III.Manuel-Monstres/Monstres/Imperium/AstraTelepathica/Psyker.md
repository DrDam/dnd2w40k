#### Psyker sanctionné {#psyker .newpage}

![Un Psyker Sanctionné utilisant la télékinésie](../../../assets/A_Sanctioned_Psyker.png){height=5cm}
...
**Classe d'armure** 13 (armure de maille)
...
**Langues** : parle une seule langue (en général le bas-gothique)

**Facteur de puissance** : 2 (450 XP)

##### Traits

**Esprit protégé.** Le psyker bénéficie d’un avantage aux jets de sauvegarde contre les effets de charme ou d’effroi.
...
**Attaque multiple.** Le psyker effectue deux attaques à la dague.

**Dague.** Attaque au corps à corps ou à distance : +4 pour toucher, portée de 1,5 mètre ou portée de 6/18 mètres, une créature. Touché : 4 (1d4+2) points de dégâts cinétiques.
