...
!!! note "Le soldat Krieg se diversifie"

    Bob a mené sont soldat Krieg au niveau 4. Lorsque son personnage gagne suffisamment de points d’expérience pour atteindre le niveau 5, Bob décide que son personnage va opter pour une multiclasse plutôt que de continuer à progresser en tant que combattant.
    Le soldat de Bob a passé beaucoup de temps avec l'Agent de Jim, et a même effectué quelques missions en parallèle en tant que chasseur de primes. Bob décide que son personnage va se multiclasser en agent ; son personnage devient donc un soldat de niveau 4 et un agent de niveau 1 (noté « combattant 4/agent 1 »).
...
| Niveau de lanceur de sorts | Niveau de puissance maximal |
| ---- | -------- |
| 1er-2e | 1er |
| 3e-4e | 2e |
| 5e-6e | 3e |
