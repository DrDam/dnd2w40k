...
!!! info "Variante : Compétences associées à différentes caractéristiques"
...
##### Capacité de lancement de sorts Technologique

Les « Mécaniciens » et les « Traqueurs » utilisent leur Intelligence comme capacité de lancement de sorts, ce qui permet de déterminer les DD des jets de sauvegarde contre les sorts qu’ils lancent.
...
##### Caractéristique de lancement de sorts psychique

Les Exorcistes, Psykers et Sorciers peuvent utiliser la Sagesse comme caractéristique de lancement de sorts, ce qui permet de déterminer les DD des jets de sauvegarde contre les sorts qu’ils lancent.
...
##### Capacité de lancement de sorts psychique

Les Exorcistes, Psykers et Sorciers peuvent utiliser le Charisme comme caractéristique de lancement de sorts, ce qui permet de déterminer les DD des jets de sauvegarde contre les sorts qu’ils lancent.
...
La classe de difficulté (CD) d’un jet de sauvegarde est déterminée par l’effet qui le provoque. Par exemple, la CD d’un jet de sauvegarde autorisé par un sort est déterminée par la capacité de lancement de sorts du lanceur et par son bonus de maîtrise.
